...
export const fpsoBravoSystemsData: SystemData[] = [
  {
    numero: 1,
    ...
    local: "Casario",
    equipamentos: [
      { code: "36-HVCP-001A", description: "Unidade Condensadora Alpha", tipo: "Unidade Condensadora (1x 50%)", fabricante: "Heinen & Hopman", modelo: "HWC 1475-C2-W-S", capacidade: "870,0 kW", condensacao: "Água do Mar", compressor: "2x Bitzer, CSH 8573-140", refrigerante: "R-407C", alimentacao: "440V – 3F – 60Hz", classificacao: "Seguro" },
      { code: "36-HVCP-001B", description: "Unidade Condensadora Bravo", tipo: "Unidade Condensadora (1x 50%, \"Stand-by\")", fabricante: "Heinen & Hopman", modelo: "HWC 1475-C2-W-S", capacidade: "870,0 kW", condensacao: "Água do Mar", compressor: "2x Bitzer, CSH 8573-140", refrigerante: "R-407C", alimentacao: "440V – 3F – 60Hz", classificacao: "Seguro" },
      { code: "36-HVAH-001A", description: "AHU Alpha", tipo: "Unidade de Tratamento de Ar (1x 50%)", fabricante: "Heinen & Hopman", modelo: "HPL.S 12.5", capacidade: "434,0 kW", condensacao: "Água Gelada", ventilador: "Centrífugo, Comefri, vazão: 18.000 m³/h", motor: "WEG, 18.5 kW, 1770 RPM", filtro: "Classe G4 (Filtro primário) + F7 (Filtro secundário)", refrigerante: "R-407C", alimentacao: "440V – 3F – 60Hz", classificacao: "Seguro" },
      { code: "36-HVAH-001B", description: "AHU Bravo", tipo: "Unidade de Tratamento de Ar (1x 50%, \"Stand-by\")", fabricante: "Heinen & Hopman", modelo: "HPL.S 12.5", capacidade: "434,0 kW", condensacao: "Água Gelada", ventilador: "Centrífugo, Comefri, vazão: 18.000 m³/h", motor: "WEG, 18.5 kW, 1770 RPM", filtro: "Classe G4 (Filtro primário) + F7 (Filtro secundário)", refrigerante: "R-407C", alimentacao: "440V – 3F – 60Hz", classificacao: "Seguro" },
    ],
  },
  {
    numero: 2,
...
export const fpsoBravoEquipmentData = fpsoBravoSystemsData.flatMap(sistema =>
...
export const getTiposSistemaFpsoBravo = (): string[] => {
  return Array.from(new Set(fpsoBravoSystemsData.map(sistema => sistema.tipo)));
};

export const getTotalEquipamentosFpsoBravo = (): number => {
  return fpsoBravoEquipmentData.length;
};